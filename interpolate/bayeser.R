...
## Collect Stan Data
setGeneric("standata",
           def = function(this, smooth=0, dropbin=9, fit=NULL) {
               standardGeneric("standata")
           })

setMethod("standata",
          signature = "BayeserObservations",
          definition = function(this, smooth=0, dropbin=9, fit=NULL) {
...
setMethod("estimate",
          signature = "BayeserObservations",
          definition = function(this, smooth=0, dropbin=9, fit=NULL) {
              stan.data <- standata(this, smooth=smooth, dropbin=dropbin, fit=fit)
