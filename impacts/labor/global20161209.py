...
def prepare_interp_raw2(csvv, weatherbundle, economicmodel, qvals, farmer='full'):
    ...
    tempcurvegen = LOrderPolynomialCurveGenerator('C', 'minutes', 4, polyvals, predgen, covarnames, farmer=farmer)
