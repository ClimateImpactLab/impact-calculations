...
def prepare_csvv(csvvpath, qvals, callback):
    ...
    negtempoffset = YearlyAverageDay('minutes', negtempoffset, 'offset to normalize to 27 degrees')
    ...
    zeroeffect = YearlyAverageDay('minutes', zerocurve, "effect from days less than 0 C")
