                ...
                for econspan in [13, 25]:
                    ...
                    if config['do_farmers'] and not weatherbundle.is_historical():
                        ...
                        if check_doit(targetdir, fullbasename + "-noadapt", suffix):
                            print "No Adaptation"
                            calculation, dependencies, baseline_get_predictors = caller.call_prepare_interp(filepath, 'impacts.labor.global20170809', weatherbundle, economicmodel, pvals[basename], farmer='noadapt', clipping=clipping, econspan=econspan)
                        ...
                        if check_doit(targetdir, fullbasename + "-incadapt", suffix):
                            ...
                            calculation, dependencies, baseline_get_predictors = caller.call_prepare_interp(filepath, 'impacts.labor.global20170809', weatherbundle, economicmodel, pvals[basename], farmer='incadapt', clipping=clipping, econspan=econspan)
