...
from openest.models.curve import ZeroInterceptPolynomialCurve, ClippedCurve, ShiftedCurve, SelectiveInputCurve, CoefficientCurve
...
def prepare_raw(csvv, weatherbundle, economicmodel, qvals):
    ...
    coeff_curve = SelectiveInputCurve(CoefficientsCurve(curve, lambda curve: curve.ccs), range(order))
