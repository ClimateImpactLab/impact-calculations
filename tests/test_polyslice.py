...
bundle_iterator = weather.iterate_combined_bundles(discover_variable(files.sharedpath('climate/BCSD/aggregation/cmip5/IR_level'), 'tas', withyear=True, rcp_only='rcp85'),
...
for weatherslice in weatherbundle.yearbundles(conversion=YearlyWeatherSlice.convert):
