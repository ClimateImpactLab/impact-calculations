...
def test_interpret_cost_args():
    ...
    assert agglib.interpret_cost_args(['clim_scenario', 'rcp_num'], 'whatever','/idontknow/rcp85/idk/idk/end','idk')[0]=='rcp85'
    # check order preserved
    assert agglib.interpret_cost_args(['rcp_num', 'clim_scenario'], 'whatever','/idontknow/rcp85/idk/idk/end','idk')[1]=='rcp85'
    # check int works
    assert agglib.interpret_cost_args(['rcp_num', 'clim_scenario'], 'whatever','/idontknow/rcp85/idk/idk/end','idk')[0]=='85'
