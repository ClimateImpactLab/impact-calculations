...
def test_interpret_cost_args():
	...
	strd = agglib.interpret_cost_args(costs_config={'ordered-args': {'extra-args': ['extraarg1', 'extraarg2'],
	...
	revert1 = agglib.interpret_cost_args(costs_config={'ordered-args': collections.OrderedDict({'use-args': ['rcp_num', 'clim_scenario'],
	...
	revert2 = agglib.interpret_cost_args(costs_config={'ordered-args': collections.OrderedDict({'use-args': ['clim_scenario', 'rcp_num'],
	...
	with pytest.raises(ValueError):
		agglib.interpret_cost_args(costs_config={'ordered-args':collections.OrderedDict({'random-args':'idk'}), 'costs-suffix':'somesuf'})
